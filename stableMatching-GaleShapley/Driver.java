...
public class  Driver{
    ...
    public static Matching parseMatchingProblemWithExample(String inputFile) throws FileNotFoundException {
        int m = 0;
        int n = 0;
    ...
    public static Matching parseMatchingProblem(String inputFile) throws FileNotFoundException {
        int m = 0;
        int n = 0;
        ArrayList<ArrayList<Integer>> universityPrefs, studentPrefs;
        ArrayList<Integer> universityPositions;
